    ...
    <article className="bg-white shadow-sm rounded border border-gray-200 p-8 max-w-2xl mx-auto text-sm font-serif leading-relaxed">
      ...
      <div className="mt-6 px-4 py-3 rounded-lg bg-amber-50 border border-amber-200">
        <p className="text-xs text-amber-800 leading-relaxed">
          <span className="font-semibold">Legal Disclaimer:</span> This document was generated by
          Prelegal for informational purposes only and does not constitute legal advice. Please
