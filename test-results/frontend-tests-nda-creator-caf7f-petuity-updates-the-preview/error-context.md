...
- Name: frontend/tests/nda-creator.spec.ts >> Mutual NDA Creator >> switching Term of Confidentiality to "in perpetuity" updates the preview
- Location: frontend/tests/nda-creator.spec.ts:73:7
