...
- Name: frontend/tests/nda-creator.spec.ts >> Mutual NDA Creator >> years input is disabled when MNDA term is set to "continues"
- Location: frontend/tests/nda-creator.spec.ts:137:7
