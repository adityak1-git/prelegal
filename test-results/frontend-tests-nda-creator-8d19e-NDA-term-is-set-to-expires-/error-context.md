...
- Name: frontend/tests/nda-creator.spec.ts >> Mutual NDA Creator >> years input is enabled when MNDA term is set to "expires"
- Location: frontend/tests/nda-creator.spec.ts:143:7
